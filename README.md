# Visual Studio Code - Open Source ("Code - Charm")
...
[Visual Studio Code](https://code.visualstudio.com) is a distribution of the `Code - Charm` repository with Microsoft-specific customizations released under a traditional [Microsoft product license](https://code.visualstudio.com/License/).
...
<!-- PLAYWRIGHT_SKIP_BROWSER_DOWNLOAD=true ELECTRON_MIRROR=http://npm.taobao.org/mirrors/electron/ yarn -->
